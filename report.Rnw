...
## Sys.setenv("MODEL-DIR" = "./md17_50000_I11_W11_LS1_KR1_pow_prelec1_random_narrow")
...
## GLOBALS (utilities use these values)
## if you change this, replace all occurences in captions
IND_IXS <- c(17, 50, 100)
MAJ_THRESHOLD <- 50
...
if (grepl("prelec2|pow2|linlog2|ibeta", modeldir)) {
  ...
  PAR_RANGE <- expression(alpha[1] - alpha[139], gamma[1]^1 - gamma[139]^1, gamma[1]^2 - gamma[139]^2,
